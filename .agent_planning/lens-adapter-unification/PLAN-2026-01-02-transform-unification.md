...
- Publisher transforms (block → bus)
- Listener transforms (bus → block)
...
Publisher ────────→ applyTransformStack() ──→ applyAdapterChain()
                                          └─→ applyLensStack()

Listener ─────────→ applyTransformStack() ──→ applyAdapterChain()
                                          └─→ applyLensStack()
```
...
- Listener transforms (lines 706-714)
- Publisher transforms (lines 1157-1187)
...
- Verify publisher transforms work
- Verify listener transforms work
