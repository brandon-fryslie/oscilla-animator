...
| `pass8-link-resolution.ts` | 786, 801 | Bus publisher validation is "placeholder/TODO" |
...
- `bus-publisher-validation` [PROPOSED]: Implement proper bus publisher validation in pass8
