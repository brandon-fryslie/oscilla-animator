...
4. Remove lines 638-640 and 682-684 (the `◂`/`▸` buttons)

**Acceptance Criteria:**
- [ ] No arrow button visible in section headers
- [ ] Clicking "↓ LISTENERS bus → input" header collapses the section
- [ ] Clicking "↑ PUBLISHERS output → bus" header collapses the section
...
**Acceptance Criteria:**
- [ ] Color/palette bus column shows rainbow emoji (🌈) instead of black square (■)
...
3. Update cell rendering to show cost indicators:
   - Green dot (`•`): Direct compatibility or cheap adapter
   - Yellow warning triangle (`⚠`): Medium cost adapter
