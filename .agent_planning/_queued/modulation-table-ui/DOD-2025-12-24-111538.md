...
**Pass Criteria:** Table width === `.listeners-section` width (559.5px ±1px)
...
**Setup:** Default 50/50 split
**Action:** Click "Collapse" button on listeners section
**Measure:** Publishers section width, publishers table width
**Pass Criteria:**
- Publishers section width ~1125px (full width)
- Publishers table width === section width (1125px ±1px)
