...
- [ ] Hover column header → tooltip shows bus name, type, publisher count
...
- [ ] Listeners section (left) renders ModulationTableGrid
- [ ] Publishers section (right) renders ModulationTableGrid
...
**Action:** Click Listeners section header
**Pass Criteria:**
- Listeners collapses to thin bar
- Publishers expands to fill width
- Publishers grid fills its container
