...
- [ ] On confirm, patch is loaded and all state (blocks, connections, lanes, buses, publishers, listeners, defaultSources, settings) is restored
...
##### Implementation Notes
- Add keyboard event listener to SettingsToolbar or root component
- Cmd/Ctrl+S → Save
- Cmd/Ctrl+O → Load
...
##### Acceptance Criteria
- [ ] Changes to blocks, connections, buses, publishers, listeners, defaultSources trigger auto-save
...
- Test cases:
  ...
  4. Patch with buses, publishers, listeners
...
- [ ] Patch with buses/publishers/listeners is tested
