...
- [ ] Lens application on wires matches bus listener performance characteristics
...
Wire connections have **feature parity** with bus listeners for lens support:
...
- Lens behavior is consistent with bus listener lenses
