...
- [ ] Tests verify new mappings (if applicable)
...
- [ ] All tests pass (compiler integration tests)
...
4. Fix tests that relied on deleted logic
...
|------|------------|--------|------------|
| Tests rely on deleted pass0 logic | High | Medium | Rewrite tests to use GraphNormalizer output |
...
6. ✅ All tests pass (`just check` succeeds)
