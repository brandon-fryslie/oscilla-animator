...
#### Technical Notes
- Use UUID library for compileId generation (e.g., crypto.randomUUID())
...
#### Description
Add diagnostic emission for bus-related issues: empty buses (no listeners) and unused outputs.
...
#### Technical Notes
- Empty bus detection: iterate busStore.buses, check listener count
- Unused output detection: iterate blocks, check outputs not in connections or publishers
