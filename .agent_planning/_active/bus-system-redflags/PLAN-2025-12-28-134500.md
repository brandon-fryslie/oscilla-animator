...
| Publisher transforms ignored in IR | pass7-bus-lowering.ts:177 | Bus values incorrect with adapters/lenses | Medium |
...
### Phase 5: Publisher Transforms (High)

**5.1 Wire transform chains in pass7-bus-lowering.ts**
- Apply adapter/lens stacks to publisher output refs
- Emit transform IR nodes between publisher and combine
...
| 5 | Publisher transforms | IR compilation | Medium |
