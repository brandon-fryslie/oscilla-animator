...
### P0: Listener Panel Bug Fix + All Blocks Visible
...
- [ ] No `◂`/`▸` arrow buttons visible in section headers
- [ ] Clicking section header text (e.g., "↓ LISTENERS bus → input") collapses that section
- [ ] Cursor shows pointer on section header hover

### P3: Rainbow Emoji
- [ ] Color/palette bus column shows 🌈 instead of ■
...
- [ ] Medium cost adapters: show yellow warning triangle (⚠) indicator
