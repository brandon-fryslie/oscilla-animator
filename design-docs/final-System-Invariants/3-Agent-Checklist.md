...
26.	Record/replay readiness: External inputs are representable as a time-stamped stream and can be replayed deterministically against a fixed program+seed.
