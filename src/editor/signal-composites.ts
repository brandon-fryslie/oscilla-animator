  ...
  exposedOutputs: [
    {
      ...
      label: 'Rotation',
      direction: 'output',
      slotType: parseTypeDesc('Field:float'),
      nodeId: 'applyAmount',
      nodePort: 'y',
    },
  ],
  ...
  exposedOutputs: [
    {
      ...
      label: 'Fill',
      direction: 'output',
      slotType: parseTypeDesc('Field:color'),
      nodeId: 'colorize',
      nodePort: 'colors',
    },
  ],
...
export const GlyphRenderer = registerComposite({
  ...
  exposedInputs: [
    ...
    },
    {
      ...
      label: 'Positions',
      direction: 'input',
      slotType: parseTypeDesc('Field:vec2'),
      nodeId: 'render',
      nodePort: 'positions',
    },
    {
