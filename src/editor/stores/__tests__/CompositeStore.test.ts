        ...
        blocks: [
          {
            ...
            category: 'Math',
            inputs: [],
            outputs: [{ id: 'value', type: 'Signal<float>', label: 'value', direction: 'output' }],
            params: {},
          },
          {
            id: 'block2',
            ...
            label: 'Scale',
            category: 'Math',
            inputs: [{ id: 'value', type: 'Signal<float>', label: 'value', direction: 'input' }],
            outputs: [{ id: 'scaled', type: 'Signal<float>', label: 'scaled', direction: 'output' }],
            params: { scale: 2 },
          },
        ],
        connections: [
        ...
        blocks: [
          {
            ...
            category: 'TimeRoot',
            inputs: [{ id: 'duration', type: 'Signal<float>', label: 'duration', direction: 'input' }],
