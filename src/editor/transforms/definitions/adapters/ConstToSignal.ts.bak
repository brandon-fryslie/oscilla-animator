...
TRANSFORM_REGISTRY.registerAdapter({
  ...
  inputType: { world: 'scalar', domain: 'int', category: 'core', busEligible: true },
  outputType: { world: 'signal', domain: 'int', category: 'core', busEligible: true },
  policy: 'AUTO',
  cost: 0.1,
  apply: (artifact: Artifact, _params: Record<string, unknown>, _ctx: CompileCtx): Artifact => {
...
TRANSFORM_REGISTRY.registerAdapter({
  ...
  inputType: { world: 'scalar', domain: 'color', category: 'core', busEligible: true },
