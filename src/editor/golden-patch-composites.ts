...
/**
 * AmbientLoopRoot - Wraps CycleTimeRoot with standard 8s period.
 *
 * The root time source for ambient loop patches.
 * Auto-publishes phase to phaseA and wrap to pulse.
 */
export const AmbientLoopRoot = registerComposite({
  id: 'AmbientLoopRoot',
  label: 'Ambient Loop Root',
...
/**
 * Register all Golden Patch composites.
 * Called during editor initialization.
 */
export function registerGoldenPatchComposites(): void {
