...
registerBlockType({
  ...
  inputs: [
    ...
    { portId: 'paths', label: 'Paths', dir: 'in', type: { world: 'field', domain: 'path' } },
    { portId: 'fillColor', label: 'Fill Color', dir: 'in', type: { world: 'field', domain: 'color' } },
    { portId: 'strokeColor', label: 'Stroke Color', dir: 'in', type: { world: 'field', domain: 'color' } },
    { portId: 'strokeWidth', label: 'Stroke Width', dir: 'in', type: { world: 'field', domain: 'number' } },
    { portId: 'opacity', label: 'Opacity', dir: 'in', type: { world: 'signal', domain: 'number' } },
  ],
  outputs: [],
