  ...
  describe('migratePatchToEdges', () => {
    ...
    it('should convert legacy publishers to edges', () => {
      ...
      const patch: Patch = {
        ...
        blocks: [],
        connections: [],
        buses: [{ id: 'pos', name: 'Position', type: busType, combineMode: 'last', defaultValue: null, sortKey: 0 }],
    ...
    it('should convert all edge types in a single patch', () => {
      ...
      const patch: Patch = {
        ...
        blocks: [],
        connections: [connection],
        buses: [{ id: 'bus1', name: 'Bus', type: busType, combineMode: 'sum', defaultValue: 0, sortKey: 0 }],
        publishers: [publisher],
        listeners: [listener],
        defaultSources: [],
        edges: [],
