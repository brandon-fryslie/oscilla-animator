...
4. If fixes are needed, make one or more commits capturing the follow-up work. If the repo is already clean and no immediate fixes are necessary, state that clearly in your response.
